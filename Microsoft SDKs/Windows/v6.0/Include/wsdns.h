...
#define WSE_Data                               WSDXML_NAME_ENCODING(17,NAMESPACE_ENCODING_EVENTING)
#define WSE_Delivery                           WSDXML_NAME_ENCODING(18,NAMESPACE_ENCODING_EVENTING)
#define WSE_Duration                           WSDXML_NAME_ENCODING(19,NAMESPACE_ENCODING_EVENTING)
#define WSE_DateTime                           WSDXML_NAME_ENCODING(20,NAMESPACE_ENCODING_EVENTING)
#define WSE_Expires                            WSDXML_NAME_ENCODING(21,NAMESPACE_ENCODING_EVENTING)
#define WSE_Dialect                            WSDXML_NAME_ENCODING(22,NAMESPACE_ENCODING_EVENTING)
#define WSE_Filter                             WSDXML_NAME_ENCODING(23,NAMESPACE_ENCODING_EVENTING)
#define WSE_Any                                WSDXML_NAME_ENCODING(24,NAMESPACE_ENCODING_EVENTING)
#define WSE_SubscriptionManager                WSDXML_NAME_ENCODING(25,NAMESPACE_ENCODING_EVENTING)
#define WSE_Any1                               WSDXML_NAME_ENCODING(26,NAMESPACE_ENCODING_EVENTING)
#define WSE_Renew                              WSDXML_NAME_ENCODING(27,NAMESPACE_ENCODING_EVENTING)
#define WSE_RenewResponse                      WSDXML_NAME_ENCODING(28,NAMESPACE_ENCODING_EVENTING)
#define WSE_GetStatus                          WSDXML_NAME_ENCODING(29,NAMESPACE_ENCODING_EVENTING)
#define WSE_GetStatusResponse                  WSDXML_NAME_ENCODING(30,NAMESPACE_ENCODING_EVENTING)
#define WSE_Unsubscribe                        WSDXML_NAME_ENCODING(31,NAMESPACE_ENCODING_EVENTING)
#define WSE_UnsubscribeResponse                WSDXML_NAME_ENCODING(32,NAMESPACE_ENCODING_EVENTING)
#define WSE_EventSink                          WSDXML_NAME_ENCODING(33,NAMESPACE_ENCODING_EVENTING)
#define WSE_SubscriptionEnd                    WSDXML_NAME_ENCODING(34,NAMESPACE_ENCODING_EVENTING)
#define WSE_Status                             WSDXML_NAME_ENCODING(35,NAMESPACE_ENCODING_EVENTING)
#define WSE_String                             WSDXML_NAME_ENCODING(36,NAMESPACE_ENCODING_EVENTING)
#define WSE_Reason                             WSDXML_NAME_ENCODING(37,NAMESPACE_ENCODING_EVENTING)
#define WSE_NotifyTo                           WSDXML_NAME_ENCODING(38,NAMESPACE_ENCODING_EVENTING)
...
#define WSD_ThisModel                  WSDXML_NAME_ENCODING(2,NAMESPACE_ENCODING_DEVPROF)
#define WSD_Manufacturer               WSDXML_NAME_ENCODING(3,NAMESPACE_ENCODING_DEVPROF)
#define WSD_ManufacturerUrl            WSDXML_NAME_ENCODING(4,NAMESPACE_ENCODING_DEVPROF)
#define WSD_ModelName                  WSDXML_NAME_ENCODING(5,NAMESPACE_ENCODING_DEVPROF)
#define WSD_ModelNumber                WSDXML_NAME_ENCODING(6,NAMESPACE_ENCODING_DEVPROF)
#define WSD_ModelUrl                   WSDXML_NAME_ENCODING(7,NAMESPACE_ENCODING_DEVPROF)
#define WSD_PresentationUrl            WSDXML_NAME_ENCODING(8,NAMESPACE_ENCODING_DEVPROF)
#define WSD_ThisDevice                 WSDXML_NAME_ENCODING(9,NAMESPACE_ENCODING_DEVPROF)
#define WSD_FriendlyName               WSDXML_NAME_ENCODING(10,NAMESPACE_ENCODING_DEVPROF)
#define WSD_FirmwareVersion            WSDXML_NAME_ENCODING(11,NAMESPACE_ENCODING_DEVPROF)
#define WSD_SerialNumber               WSDXML_NAME_ENCODING(12,NAMESPACE_ENCODING_DEVPROF)
#define WSD_Actions                    WSDXML_NAME_ENCODING(13,NAMESPACE_ENCODING_DEVPROF)
#define WSD_Types                      WSDXML_NAME_ENCODING(14,NAMESPACE_ENCODING_DEVPROF)
#define WSD_ServiceId                  WSDXML_NAME_ENCODING(15,NAMESPACE_ENCODING_DEVPROF)
#define WSD_Host                       WSDXML_NAME_ENCODING(16,NAMESPACE_ENCODING_DEVPROF)
#define WSD_Hosted                     WSDXML_NAME_ENCODING(17,NAMESPACE_ENCODING_DEVPROF)
#define WSD_Element                    WSDXML_NAME_ENCODING(18,NAMESPACE_ENCODING_DEVPROF)
