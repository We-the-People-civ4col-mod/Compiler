...
BOOL IsolationAwarePrivatenCv IsolationAwareUnregisterClassA(__in LPCSTR lpClassName,__in HINSTANCE hInstance);
BOOL IsolationAwarePrivatenCv IsolationAwareUnregisterClassW(__in LPCWSTR lpClassName,__in HINSTANCE hInstance);
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareUnregisterClassA(__in LPCSTR lpClassName,__in HINSTANCE hInstance)
{
    BOOL fResult = FALSE;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
...
ISOLATION_AWARE_INLINE BOOL IsolationAwarePrivatenCv IsolationAwareUnregisterClassW(__in LPCWSTR lpClassName,__in HINSTANCE hInstance)
{
    BOOL fResult = FALSE;
    ULONG_PTR  ulpCookie = 0;
    const BOOL fActivateActCtxSuccess =
