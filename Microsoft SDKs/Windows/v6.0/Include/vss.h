...
enum _VSS_FASTRECOVERY_OPTIONS
    {	VSS_BREAK_FLAG_MASK_LUNS	= 0x1,
	VSS_BREAK_FLAG_MAKE_READ_WRITE	= 0x2,
	VSS_FAST_RECOVERY_LUN_REPOINT	= 0x4,
	VSS_FAST_RECOVERY_LUN_RESYNC	= 0x8
    } ;
typedef 
